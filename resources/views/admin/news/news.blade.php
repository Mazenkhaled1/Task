    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <!-- عرض الصورة الخلفية -->
            <img src="{{ asset('storage/' . $new->background_image) }}" alt="Background Image" width="100" height="100">
          </td>
          <td>
            <!-- Button to open the popup with the contact ID -->
            <button class="update-btn" onclick="openModal({{ $new->id }})">تحديث</button>
          </td>        
        </tr>
        @endforeach
      </tbody>
...
<div id="updateModal" class="modal">
  <div class="modal-content">
    ...
    <form id="updateForm" action="{{ route('news.update', ':id') }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
