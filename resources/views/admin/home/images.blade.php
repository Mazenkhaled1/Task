...
@section('main')
<h2 style="text-align: center; width: 100%;">Home - Images Information</h2>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
            <td>
              <!-- عرض الصورة الخلفية -->
              <img src="{{ asset('storage/' . $image->src) }}" alt="Background Image" width="100" height="100">
            </td>
          <td>{{ $image->alt }}</td>
          <td>
            <!-- Button to open the popup with the contact ID -->
            <button class="update-btn" onclick="openModal({{ $image->id }})">تحديث</button>
          </td>        
        </tr>
        @endforeach
      </tbody>
...
<div id="updateModal" class="modal">
  <div class="modal-content">
    ...
    <form id="updateForm" action="{{ route('home_image.update', ':id') }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      ...
      <div class="form-group">
        ...
        <input type="file" id="src" name="src" class="form-control" required>
      </div>
