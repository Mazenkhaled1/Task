    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <img src="{{ asset('storage/' . $facility->icon) }}" alt="Background Image" width="100" height="100">
          </td>
          <td>
            <button class="btn-update" onclick="openModal({{ $facility->id }})">تحديث</button>
          </td>        
        </tr>
        @endforeach
      </tbody>
...
<div id="postModal" class="modal">
    <div class="modal-content">
      ...
      <h3 class="text-center mb-4" id="modalTitle">Add New facility</h3>
      <form id="postForm" action="{{ route('home_facility.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
...
<div id="updateModal" class="modal">
  <div class="modal-content">
    ...
    <form id="updateForm" action="{{ route('home_facility.update', ':id') }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
...
<script>
  ...
  function openAddModal() {
    ...
    document.getElementById("postForm").action = "{{ route('home_facility.store') }}";
